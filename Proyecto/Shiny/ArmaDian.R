...
file_path <- "C:/Users/LENOVO/Desktop/Universidad/Series de tiempo/Series_de_tiempo/dian_esta.csv"  # Cambia esto a la ruta de tu archivo

# Interfaz de usuario
ui <- fluidPage(
  titlePanel("Modelo de la familia ARMA para la serie de tiempo de la DIAN"),
  br(),
  p("Esta aplicación permite modelar la serie de tiempo de la DIAN usando modelos de la familia ARMA. Por favor selecciona el orden autorregresivo y de promedios móviles que consideras apropiado, puedes guiarte de la función de autocorrelación y autocorrelación parcial de la serie."),
  sidebarLayout(
    sidebarPanel(
